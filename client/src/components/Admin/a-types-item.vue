  ...
  <tr>
    ...
    <th class="">
      <transition-group>
        ...
        <button class="btn btn-ghost text-base-600 btn-md w-28" v-if="toggleChange" @click="sendChangeType">Сохранить</button>
        <button class="btn btn-ghost text-red-400 btn-md" @click="sendDelType">Удалить</button>
      </transition-group>
    </th>
  </tr>
</template>
...
export default {
  ...
  methods: {
    ...
    sendChangeType() {
      if (this.inputName === this.type_data.name) {
